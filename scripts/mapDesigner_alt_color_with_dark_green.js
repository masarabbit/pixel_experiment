function init() {
  ...
  const svgData = {
    't': { svg: tree, color: '#5ffe8f' },
    'w': { svg: tree, color: '#5ffe8f' },
    ...
    'bx': { svg: roofTopBottomCorner, color: main, subColor: '#5ffe8f' },
    'by': { svg: roofTopBottomCorner, color: main, subColor: '#5ffe8f', flip: 'h' },
    ...
    'b': { svg: plain, subColor: '#029e61' },
    'bd': { svg: plain, subColor: '#5ffe8f' },
